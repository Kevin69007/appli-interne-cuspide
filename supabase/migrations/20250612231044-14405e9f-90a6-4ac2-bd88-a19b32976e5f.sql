...
-- Add 3125 Paw Dollars to leoandoreosmom's account
...
SELECT id, id, 3125, 'Admin credit: 3125 Paw Dollars added to account'
FROM public.profiles 
WHERE username = 'leoandoreosmom';

-- Add 200 Paw Dollars to Bumblebee's account
UPDATE public.profiles 
