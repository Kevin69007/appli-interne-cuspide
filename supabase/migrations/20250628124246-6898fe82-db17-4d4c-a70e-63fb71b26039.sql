...
-- Fix shelter sale foreign key constraint issue by cleaning up breeding pairs
...
BEGIN
  ...
  -- Step 1.5: Clean up any completed breeding pairs that reference this pet
  step_counter := step_counter + 1;
  RAISE NOTICE '🧹 STEP %: Cleaning up completed breeding pairs', step_counter;
