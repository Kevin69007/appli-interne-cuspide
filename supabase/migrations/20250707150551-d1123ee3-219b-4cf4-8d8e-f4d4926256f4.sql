...
-- Reset litter 26 to allow collection
UPDATE breeding_pairs 
SET is_completed = false 
WHERE litter_number = 26 AND is_completed = true;

-- Update the collect_breeding_babies function to handle completed pairs with remaining babies
