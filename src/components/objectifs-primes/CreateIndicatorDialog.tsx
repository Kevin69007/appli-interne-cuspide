...
interface CreateIndicatorDialogProps {
  onIndicatorCreated: (indicator: Indicator) => void;
  totalPointsConfig: number;
  currentTotal: number;
}

export const CreateIndicatorDialog = ({ onIndicatorCreated, totalPointsConfig, currentTotal }: CreateIndicatorDialogProps) => {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <Label htmlFor="indicateur">Unité de mesure</Label>
            <Input
              id="indicateur"
          ...
          <div>
            ...
            {isOverLimit && (
              <p className="text-xs text-destructive mt-1">
                ⚠️ Le total des points dépasse {totalPointsConfig}
              </p>
            )}
          </div>
...
export { CreateIndicatorDialog as CreateObjectiveDialog };
